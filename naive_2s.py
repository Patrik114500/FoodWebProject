...
class Animal(object):
    ...
    def __init__(self, x0, y0, init_energy, species,
                 ...
                 reborn_chance,
                 rabbit_being_eaten_chance, fox_being_eaten_chance ,
...
def run_simulation(params, record = True):
    ...
    wolfs = params['foxes'] # initial number of foxes    
    wolf_energy_level = params['fox_energy_level']# initial energy level of a fox
    wolf_newborn_chance = params['fox_newborn_chance']  # chance of a fox being born in a grid
    wolf_being_dead_chance = params['fox_being_dead_chance'] # chance of a fox dying
    ...
    rabbit_nums, fox_nums, wolf_nums = [rabbits], [foxes], [wolfs]
    ...
    with open("D:/0xMESTERI_II_EV/1_FELEV/Computational_Intelligence/PROJECT/Results/" + "results.json", "w") as f:
        ...
        json.dump([rabbit_nums, fox_nums, wolf_nums], f, indent=5)

    ###TO DO: what is fittnes  
    return 0, [rabbit_nums, fox_nums, wolf_nums]
...
param_grid = {
    ...
    "wolfs": [5],
    "wolf_energy_level": [25],
    "wolf_newborn_chance": [0.05],
    "wolf_being_dead_chance" : [0.04]
    }

results = simulation_space(1, param_grid)
...
#plt.plot(range(1000, 1000 + len(wolf_nums)), wolf_nums, 'black', label = 'wolfs')
